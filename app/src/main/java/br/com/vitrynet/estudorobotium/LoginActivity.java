...
public class LoginActivity extends Activity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent proximaTela = new Intent(LoginActivity.this, UsuarioAutenticadoActivity.class);
                proximaTela.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
